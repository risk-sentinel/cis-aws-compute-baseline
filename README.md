...
curl -LO https://github.com/risk-sentinel/cis-aws-compute-baseline/releases/download/$VERSION/cis-aws-compute-v1.1.0-$VERSION.tar.gz

# then, on the isolated side
mkdir -p cis-aws-compute-v1.1.0 && tar xzf cis-aws-compute-v1.1.0-$VERSION.tar.gz -C cis-aws-compute-v1.1.0
cd cis-aws-compute-v1.1.0
...
```yaml
uses: risk-sentinel/cis-aws-compute-baseline/.github/workflows/exec-evidence.yml@<version>
with:
  profile_source: archive
  archive_path: ./cis-aws-compute-v1.1.0-<version>.tar.gz
```
...
```yaml
include:
  - project: <your-org>/cis-aws-compute-baseline
    ref: <version>
